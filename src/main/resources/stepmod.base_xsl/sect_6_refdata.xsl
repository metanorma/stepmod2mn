...
<xsl:template match="module">
  <xsl:call-template name="clause_header">
    ...
    <p class="note">
      <small>
        NOTE-1 &#160;&#160;A URI can be a HTTP URI. However, the use of a HTTP URI does not necessarily mean that a HTTP GET obtains a representation of the specified resource. Even if a representation is obtained, that representation is not necessarily part of the standard.
     </small>
    </p>
