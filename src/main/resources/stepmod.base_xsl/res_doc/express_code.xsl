...
<!--
     $Id: express_code.xsl,v 1.18 2019/10/09 19:29:30 tom Exp $
...
<xsl:template match="interface" mode="source_2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="select" mode="underlying2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="enumeration" mode="underlying2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:if test="@extensible='YES' or @extensible='yes'">
    EXTENSIBLE
  </xsl:if>
  ENUMERATION
...
<xsl:template name="abstract.entity2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:if test="@abstract.entity='YES' or @abstract.entity='yes'">
    ABSTRACT</xsl:if>
</xsl:template>


<xsl:template name="super.expression-code2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template name="supertypes-code2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="explicit" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable name="aname">
    <xsl:call-template name="express_a_name">
      <xsl:with-param name="section1" select="../../@name"/>
      <xsl:with-param name="section2" select="../@name"/>
...
&#160;&#160;<xsl:apply-templates select="./redeclaration" mode="code"/>
 ...
 <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="derived" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable name="aname">
    <xsl:call-template name="express_a_name">
      <xsl:with-param name="section1" select="../../@name"/>
      <xsl:with-param name="section2" select="../@name"/>
...
<xsl:template match="inverse" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable name="aname">
    <xsl:call-template name="express_a_name">
      <xsl:with-param name="section1" select="../../@name"/>
      <xsl:with-param name="section2" select="../@name"/>
...
<xsl:template match="inverse.aggregate" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:choose>
    <xsl:when test="@lower">
      <xsl:value-of select="concat(@type, '[', @lower, ':', @upper, '] OF ')"/>
    </xsl:when>
...
<xsl:template match="unique" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable name="aname">
    <xsl:call-template name="express_a_name">
      <xsl:with-param name="section1" select="../../@name"/>
      <xsl:with-param name="section2" select="../@name"/>
...
<xsl:template match="unique.attribute" mode="code2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="aggregate" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:choose>
    <xsl:when test="@lower">
      <xsl:value-of select="concat(@type, '[', @lower, ':', @upper, '] OF ')"/>
    </xsl:when>
...
<xsl:template name="output_where_formal2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:if test="./where[@expression] and not(./unique)">
    <xsl:apply-templates select="./where[@expression]" mode="code"/>
  </xsl:if>
</xsl:template>

<xsl:template match="where" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable name="aname">
    <xsl:call-template name="express_a_name">
      <xsl:with-param name="section1" select="../../@name"/>
      <xsl:with-param name="section2" select="../@name"/>
...
<xsl:template match="function" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <xsl:variable 
    name="schema_name" 
    select="../@name"/>      
...
<!-- empty template to prevent the algorithm element being out put along
     with the code -->
<xsl:template match="parameter" mode="underlying2"/> <!-- there is in sect_4_express.xsl already -->

<xsl:template match="parameter" mode="code2"> <!-- there is in sect_4_express.xsl already -->
...
<xsl:template match="algorithm" mode="code2"> <!-- there is in sect_4_express.xsl already -->
...
<!-- empty template to prevent the algorithm element being out put along
     with the code -->
<xsl:template match="algorithm" mode="underlying2"/> <!-- there is in sect_4_express.xsl already -->



<xsl:template match="procedure" mode="code2">     <!-- there is in sect_4_express.xsl already -->
  <xsl:variable 
    name="schema_name" 
    select="../@name"/>      
...
<xsl:template match="rule" mode="code2">   <!-- there is in sect_4_express.xsl already -->
<code>
  <xsl:variable 
    name="schema_name" 
    select="../@name"/>      
...
<xsl:template match="subtype.constraint" mode="code2"> <!-- there is in sect_4_express.xsl already -->
  <code>
  <xsl:variable 
    name="schema_name" 
    select="../@name"/>      
