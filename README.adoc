...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar <XML-FileName> --output <AsciiDoc-FileName>
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar data/resource_docs/draughting_elements/resource.xml --output result_dir/draughting_elements/document.adoc
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar data/
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar publication/part1000/CR_PMI_5/publication_index.xml
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar <Publication-Index-XML-FileName> --type <resource_docs or modules>
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.16.jar publication/part1000/CR_PMI_5/publication_index.xml --type resource_docs
----
