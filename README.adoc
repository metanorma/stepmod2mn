...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <XML-FileName>
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/resource_docs/draughting_elements/resource.xml 
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <XML-FileName> [--output <AsciiDoc-FileName>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/resource_docs/draughting_elements/resource.xml --output result_dir/draughting_elements/document.adoc
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Input-folder>
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Input-folder> [--output <Output-folder>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/ --output documents/
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Input-folder> [--exclude <documents list>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/ --exclude "machining_features"
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Input-folder> [--include-only <documents list>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar data/ --include-only "fundamentals_of_product_description_and_support kinematics"
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Publication-Index-XML-FileName>
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar publication/part1000/CR_PMI_5/publication_index.xml
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Publication-Index-XML-FileName> [--output <Output-folder>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar iso-10303-srl/iso-10303-stepmod-wg12/publication/part1000/CR_PMI_5/publication_index.xml --output iso-10303-srl/
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar iso-10303-srl/iso-10303-stepmod-wg12/publication/part1000/CR_PMI_5/publication_index.xml --output iso-10303-srl/CR_PMI_5 --input-documents iso-10303-srl/documents
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar <Publication-Index-XML-FileName> [--type <resource_docs or modules>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.41.jar publication/part1000/CR_PMI_5/publication_index.xml --type resource_docs
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.41.jar <start folder to process xml maps files> --svg
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.41.jar data/resources --svg
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.41.jar <start folder to process xml maps files> --svg [--output <Output-folder>]
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.41.jar data/resources --svg --output schemas/
----
...
[source,sh]
----
java -jar stepmod2mn-1.41.jar --xml <Express Imagemap XML file path> --image <Image file name> [--svg <resulted SVG map file or folder>]
----
...
[source,sh]
----
java -jar stepmod2mn-1.41.jar --xml data\resource_docs\fundamentals_of_product_description_and_support\schema_diagexpg1.xml --image schema_diagexpg1.gif --svg schema_diagexpg1.svg
----
