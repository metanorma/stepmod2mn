...
[source,sh]
----
java -jar target/stepmod2mn-1.9.jar <XML-FileName>
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.9.jar <XML-FileName> --output <ADOC-FileName>
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.9.jar <start folder to process xml maps files> --svg
----
...
[source,sh]
----
java -jar stepmod2mn-1.9.jar --xml <Express Imagemap XML file path> --image <Image file name> [--svg <resulted SVG map file or folder>]
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.9.jar data/resource_docs/draughting_elements/resource.xml 
----

[source,sh]
----
java -jar target/stepmod2mn-1.9.jar data/ --svg
----

[source,sh]
----
java -jar stepmod2mn-1.9.jar --xml data\resource_docs\fundamentals_of_product_description_and_support\schema_diagexpg1.xml --image schema_diagexpg1.gif --svg schema_diagexpg1.svg
----
