...
[source,sh]
----
java -jar target/stepmod2mn-1.0.jar <XML-FileName>
----

[source,sh]
----
java -jar target/stepmod2mn-1.0.jar <XML-FileName> --output <ADOC-FileName>
----
...
[source,sh]
----
java -jar target/stepmod2mn-1.0.jar data/resource_docs/draughting_elements/resource.xml 
----
