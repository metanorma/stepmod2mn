...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.45.jar <Input-folder> [--exclude <documents list>]
----
...
[source,sh]
----
java -Xss5m -jar target/stepmod2mn-1.45.jar data/ --exclude "machining_features"
----
